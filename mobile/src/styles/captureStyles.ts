...
export const makeStyles = ({
  ...
  StyleSheet.create({
    ...
    processingText:    { fontFamily: fonts.mono, color: colors.primary, marginTop: spacing.lg, fontSize: fontSizes.h3, textAlign: 'center', paddingHorizontal: layout.screenPaddingH },
    ...
    resultTitle:       { fontFamily: fonts.heading, fontSize: fontSizes.h3, color: colors.primary, marginBottom: spacing.xs },
    resultDesc:        { fontFamily: fonts.body, fontSize: fontSizes.body, color: colors.textSecondary, lineHeight: fontSizes.body * 1.5, marginBottom: spacing.sm },
    resultMeta:        { fontFamily: fonts.mono, fontSize: fontSizes.micro, color: colors.textMuted, textTransform: 'uppercase' as const, letterSpacing: 1 },
    resultMetaRow:     { flexDirection: 'row' as const, gap: spacing.md, marginBottom: spacing.sm },
    resultMetaValue:   { fontFamily: fonts.mono, fontSize: fontSizes.caption, color: colors.textPrimary },
